...
- self_under_pressure means players are voting you or directly accusing you.
- self_visible_votes counts visible votes currently placed on you.
- self_accusations counts direct plain-English suspicion against you.
...
- If self_under_pressure is true, answer the pressure before asking a generic
  meeting question.
- If two or more visible votes are on you, give your route and task work first,
  then ask the strongest accuser for the exact sighting.
- If someone says you were near a body, do not just ask who was near it. Say
  where you were, what task work you did, and ask that accuser for details.
- A self-defense should be calm and factual: rooms, tasks, who saw you, then
  one focused challenge to the accuser or reporter.
...
- "I was Bridge to Storage Deck. Task work in Bridge. Yellow, give exact sighting."
- "Do not pile me yet. I was Hydroponics then Science Bay doing tasks."
- "I crossed Storage Deck only. Reporter, where exactly was the body?"
- "I answered route and tasks. Blue, what did you actually see?"
- "That accusation needs detail. I was in Bridge task work, then Shuttle Bay."
- "I was with red in Bridge earlier. Yellow, say when you saw me near danger."
- "Votes on me are too fast. I was doing tasks; accuser needs exact room."
- "I passed the area, but proximity is not a kill. Who saw the actual hit?"
